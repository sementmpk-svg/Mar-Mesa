...
const HeroWaves = () => (
  <svg viewBox="0 0 480 220" preserveAspectRatio="xMidYMid slice" style={{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none"}}>
    ...
    <path d="M-20,62 Q100,48 180,64 Q260,80 340,58 Q420,38 520,62" fill="none" stroke={TEAL} strokeWidth="0.4" opacity="0.08"/>
    <path d="M-20,158 Q60,138 140,158 Q220,178 300,156 Q380,134 500,156" fill="none" stroke={TEAL} strokeWidth="0.7" opacity="0.22"/>
    <path d="M-20,174 Q80,156 160,174 Q240,192 320,170 Q400,150 520,172" fill="none" stroke={TEAL} strokeWidth="0.5" opacity="0.13"/>
    {/* Ракушка */}
    <g transform="translate(408,14)" opacity="0.18">
      <path d="M22,22 Q22,8 8,8 Q-4,8 -4,22 Q-4,36 10,38 Q26,40 30,26 Q34,12 20,4 Q6,-4 -2,10" fill="none" stroke={SAND} strokeWidth="1"/>
      <circle cx="10" cy="22" r="4" fill="none" stroke={SAND} strokeWidth="0.8"/>
    </g>
    {/* Морская звезда */}
    <g transform="translate(18,10)" opacity="0.15">
      <path d="M14,2 L16,10 L24,8 L18,14 L22,22 L14,18 L6,22 L10,14 L4,8 L12,10 Z" fill="none" stroke={TEAL} strokeWidth="0.8"/>
    </g>
    {/* Рыбка */}
    <g transform="translate(390,175)" opacity="0.14">
      <path d="M0,8 Q8,2 18,8 Q8,14 0,8 Z" fill="none" stroke={TEAL} strokeWidth="0.8"/>
      <path d="M0,8 L-8,3 L-6,8 L-8,13 Z" fill="none" stroke={TEAL} strokeWidth="0.7"/>
      <circle cx="14" cy="7" r="1" fill={TEAL}/>
    </g>
    {/* Якорь */}
    <g transform="translate(24,168)" opacity="0.13">
      <line x1="10" y1="2" x2="10" y2="22" stroke={SAND} strokeWidth="1"/>
      <line x1="4" y1="6" x2="16" y2="6" stroke={SAND} strokeWidth="1"/>
      <path d="M10,22 Q2,18 4,12" fill="none" stroke={SAND} strokeWidth="0.9"/>
      <path d="M10,22 Q18,18 16,12" fill="none" stroke={SAND} strokeWidth="0.9"/>
      <circle cx="10" cy="3" r="2.5" fill="none" stroke={SAND} strokeWidth="0.9"/>
    </g>
    {/* Пузырьки */}
    <circle cx="60" cy="90" r="1.5" fill="none" stroke={TEAL} strokeWidth="0.6" opacity="0.15"/>
    <circle cx="68" cy="82" r="1" fill="none" stroke={TEAL} strokeWidth="0.5" opacity="0.12"/>
    <circle cx="54" cy="76" r="2" fill="none" stroke={TEAL} strokeWidth="0.5" opacity="0.10"/>
    <circle cx="420" cy="110" r="1.5" fill="none" stroke={TEAL} strokeWidth="0.6" opacity="0.15"/>
    <circle cx="428" cy="100" r="1" fill="none" stroke={TEAL} strokeWidth="0.5" opacity="0.12"/>
  </svg>
);

const WaveDivider = () => (
  <div style={{padding:"20px 20px 0",opacity:0.4}}>
    <svg viewBox="0 0 480 20" style={{width:"100%"}} xmlns="http://www.w3.org/2000/svg">
...
// ===================== TRADUCCIONES =====================
const T = {
  es: { flag:"🇪🇸", langName:"Español",   todo:"Todo", oferta:"Chef recomienda", mediospago:"Medios de pago", efectivo:"Efectivo", tarjeta:"Tarjeta", precios:"Precios en pesos argentinos · IVA incluido", verPedido:"🛒 Carrito", tuPedido:"Tu pedido", revisaPedido:"Revisá tu pedido", mostrarMozo:"¡Listo! Mostrá esta pantalla al mozo", instruccion:"El mozo tomará nota de tu pedido", carritoVacio:"Tu carrito está vacío", verMenu:"Ver menú", confirmar:"Confirmar y llamar al mozo", volver:"← Volver", cu:"c/u", item:"item", items:"items", nuevoPedido:"Nuevo pedido", encuesta:"¿Cómo fue tu experiencia?", encuestaSubtitulo:"Tu opinión nos ayuda a mejorar", enviarEncuesta:"Enviar opinión", saltarEncuesta:"Saltar", graciasEncuesta:"¡Gracias! 🙏" },
  en: { flag:"🇬🇧", langName:"English",   todo:"All",  oferta:"Chef recommends", mediospago:"Payment methods", efectivo:"Cash", tarjeta:"Card", precios:"Prices in Argentine pesos · VAT included", verPedido:"🛒 Cart", tuPedido:"Your order", revisaPedido:"Review your order", mostrarMozo:"Done! Show this screen to the waiter", instruccion:"The waiter will take note of your order", carritoVacio:"Your cart is empty", verMenu:"See menu", confirmar:"Confirm & call waiter", volver:"← Back", cu:"each", item:"item", items:"items", nuevoPedido:"New order", encuesta:"How was your experience?", encuestaSubtitulo:"Your feedback helps us improve", enviarEncuesta:"Send feedback", saltarEncuesta:"Skip", graciasEncuesta:"Thanks! 🙏" },
  pt: { flag:"🇧🇷", langName:"Português", todo:"Tudo", oferta:"Chef recomenda", mediospago:"Formas de pagamento", efectivo:"Dinheiro", tarjeta:"Cartão", precios:"Preços em pesos argentinos · IVA incluído", verPedido:"🛒 Carrinho", tuPedido:"Seu pedido", revisaPedido:"Revise seu pedido", mostrarMozo:"Pronto! Mostre esta tela ao garçom", instruccion:"O garçom anotará seu pedido", carritoVacio:"Seu carrinho está vazio", verMenu:"Ver cardápio", confirmar:"Confirmar e chamar o garçom", volver:"← Voltar", cu:"un.", item:"item", items:"itens", nuevoPedido:"Novo pedido", encuesta:"Como foi sua experiência?", encuestaSubtitulo:"Sua opinião nos ajuda a melhorar", enviarEncuesta:"Enviar opinião", saltarEncuesta:"Pular", graciasEncuesta:"Obrigado! 🙏" },
  it: { flag:"🇮🇹", langName:"Italiano",  todo:"Tutto",oferta:"Lo chef consiglia", mediospago:"Metodi di pagamento", efectivo:"Contanti", tarjeta:"Carta", precios:"Prezzi in pesos argentini · IVA inclusa", verPedido:"🛒 Carrello", tuPedido:"Il tuo ordine", revisaPedido:"Rivedi il tuo ordine", mostrarMozo:"Fatto! Mostra questo schermo al cameriere", instruccion:"Il cameriere prenderà nota del tuo ordine", carritoVacio:"Il carrello è vuoto", verMenu:"Vedi menù", confirmar:"Conferma e chiama il cameriere", volver:"← Torna", cu:"cad.", item:"articolo", items:"articoli", nuevoPedido:"Nuovo ordine", encuesta:"Com'è stata la tua esperienza?", encuestaSubtitulo:"La tua opinione ci aiuta a migliorare", enviarEncuesta:"Invia opinione", saltarEncuesta:"Salta", graciasEncuesta:"Grazie! 🙏" },
  fr: { flag:"🇫🇷", langName:"Français",  todo:"Tout", oferta:"Le chef recommande", mediospago:"Moyens de paiement", efectivo:"Espèces", tarjeta:"Carte", precios:"Prix en pesos argentins · TVA incluse", verPedido:"🛒 Panier", tuPedido:"Votre commande", revisaPedido:"Vérifiez votre commande", mostrarMozo:"Prêt ! Montrez cet écran au serveur", instruccion:"Le serveur notera votre commande", carritoVacio:"Votre panier est vide", verMenu:"Voir le menu", confirmar:"Confirmer et appeler le serveur", volver:"← Retour", cu:"p/u", item:"article", items:"articles", nuevoPedido:"Nouvelle commande", encuesta:"Comment était votre expérience ?", encuestaSubtitulo:"Votre avis nous aide à améliorer", enviarEncuesta:"Envoyer l'avis", saltarEncuesta:"Passer", graciasEncuesta:"Merci ! 🙏" },
  ru: { flag:"🇷🇺", langName:"Русский",   todo:"Всё",  oferta:"Рекомендует шеф", mediospago:"Способы оплаты", efectivo:"Наличные", tarjeta:"Карта", precios:"Цены в аргентинских песо · НДС включён", verPedido:"🛒 Корзина", tuPedido:"Ваш заказ", revisaPedido:"Проверьте ваш заказ", mostrarMozo:"Готово! Покажите экран официанту", instruccion:"Официант запишет ваш заказ", carritoVacio:"Корзина пуста", verMenu:"Смотреть меню", confirmar:"Подтвердить и позвать официанта", volver:"← Назад", cu:"шт.", item:"позиция", items:"позиции", nuevoPedido:"Новый заказ", encuesta:"Как вам наше меню?", encuestaSubtitulo:"Ваше мнение помогает нам стать лучше", enviarEncuesta:"Отправить отзыв", saltarEncuesta:"Пропустить", graciasEncuesta:"Спасибо! 🙏" },
};
...
const MENU = [
  ...
  { categoria:"Entradas",  nombre:"Pulpo a la parrilla",    descripcion:"Chimichurri de hierbas frescas y papas al olivo",                        precio:3200, disponible:true, emoji:"🐙", promo:false, t:{ en:["Grilled octopus","Fresh herb chimichurri and olive oil potatoes"],              pt:["Polvo grelhado","Chimichurri de ervas frescas e batatas ao azeite"],           it:["Polpo alla griglia","Chimichurri alle erbe fresche e patate all'olio"],          fr:["Poulpe grillé","Chimichurri aux herbes fraîches et pommes de terre à l'huile"],  ru:["Осьминог на гриле","Свежий чимичурри с травами и картофель с оливками"] } },
  { categoria:"Pescados",  nombre:"Merluza al limón",       descripcion:"Filete, manteca de limón, alcaparras y arroz blanco",                    precio:3800, disponible:true, emoji:"🐟", promo:false, t:{ en:["Lemon hake","Fillet, lemon butter, capers and white rice"],                    pt:["Merluza ao limão","Filé, manteiga de limão, alcaparras e arroz branco"],      it:["Merluzzo al limone","Filetto, burro al limone, capperi e riso bianco"],          fr:["Merlu au citron","Filet, beurre citronné, câpres et riz blanc"],               ru:["Хек с лимоном","Филе, лимонное масло, каперсы и белый рис"] } },
  { categoria:"Pescados",  nombre:"Salmón a la plancha",    descripcion:"Rúcula, palta y aderezo de mostaza antigua",                             precio:4500, disponible:true, emoji:"🍣", promo:true,  t:{ en:["Pan-seared salmon","Arugula, avocado and whole grain mustard dressing"],       pt:["Salmão grelhado","Rúcula, abacate e molho de mostarda à antiga"],             it:["Salmone alla piastra","Rucola, avocado e vinaigrette alla senape"],              fr:["Saumon poêlé","Roquette, avocat et vinaigrette à la moutarde ancienne"],        ru:["Жареный лосось","Руккола, авокадо и соус из зернистой горчицы"] } },
  ...
  { categoria:"Postres",   nombre:"Tarta de limón",         descripcion:"Masa sablé, crema de limón y merengue italiano",                         precio:1600, disponible:true, emoji:"🍋", promo:true,  t:{ en:["Lemon tart","Shortcrust pastry, lemon cream and Italian meringue"],           pt:["Torta de limão","Massa sablé, creme de limão e merengue italiano"],           it:["Crostata al limone","Pasta sablé, crema al limone e meringa italiana"],         fr:["Tarte au citron","Pâte sablée, crème au citron et meringue italienne"],        ru:["Лимонный тарт","Песочное тесто, лимонный крем и итальянская меренга"] } },
];
...
function et(k:keyof typeof ENC_T,l:Lang){return ENC_T[k][l]??ENC_T[k].es;}
...
function Encuesta({lang,onSubmit,onSkip}:{lang:Lang,onSubmit:(s:Survey)=>void,onSkip:()=>void}){
  ...
  const btnS=(active:boolean,col:string)=>({flex:1,padding:"12px 6px",border:`1px solid ${active?col:BORDER}`,background:active?col:"transparent",color:active?WHITE:MUTED,fontSize:11,cursor:"pointer",fontFamily:"inherit",display:"flex",flexDirection:"column" as const,alignItems:"center" as const,gap:4,transition:"all 0.2s",borderRadius:4,letterSpacing:"0.5px"});
  if(enviado)return(<div style={{textAlign:"center",padding:"60px 20px",background:CREAM,minHeight:"100vh",color:NAVY,fontFamily:"'Jost',sans-serif"}}><style>{FONTS}</style><div style={{fontSize:48,marginBottom:12}}>🐚</div><div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:26,fontStyle:"italic",color:TEAL2}}>{et("gracias",lang)}</div></div>);
  return(
    <div style={{background:CREAM,minHeight:"100vh",fontFamily:"'Jost',sans-serif",fontWeight:300,color:NAVY,paddingBottom:60,overflowX:"hidden"}}>
      <style>{FONTS}</style>
      ...
      <div style={{padding:"24px 20px",display:"flex",flexDirection:"column",gap:14,maxWidth:480,margin:"0 auto"}}>
        ...
        {[
          ...
          <div key={qi} style={{background:WHITE,padding:"20px",border:`1px solid ${BORDER}`}}>
            ...
            <div style={{display:"flex",gap:8}}>{q.opts.map(op=>(<button key={op.id} onClick={()=>q.set(op.id)} style={btnS(q.state===op.id,q.col)}>
              <span style={{fontSize:18}}>{et(op.l as keyof typeof ENC_T,lang).split(" ")[0]}</span>
              <span style={{fontSize:10}}>{et(op.l as keyof typeof ENC_T,lang).split(" ").slice(1).join(" ")}</span>
            </button>))}</div>
          </div>
        ))}
        {/* Comentario */}
        ...
        {total===0?(<div style={{textAlign:"center",padding:"60px 20px",color:MUTED}}><div style={{fontSize:40}}>📭</div><div style={{marginTop:12,fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontStyle:"italic"}}>Sin respuestas aún</div></div>):(
          <>
            ...
            {comments.length>0&&(<div style={{background:WHITE,padding:"16px",border:`1px solid ${BORDER}`}}>
              ...
              {comments.slice(-5).reverse().map((s,i)=>(<div key={i} style={{borderBottom:`1px solid ${BORDER}`,padding:"10px 0"}}><div style={{fontSize:10,color:MUTED,marginBottom:4}}>{s.fecha} · {T[s.lang as Lang]?.flag} · {"⭐".repeat(s.estrellas)}</div><div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:15,fontStyle:"italic",color:NAVY}}>{s.comentario}</div></div>))}
            </div>)}
...
export default function App(){
  ...
  if(!langSelected){
    ...
    return(
      <div style={{position:"fixed",inset:0,background:CREAM,fontFamily:"'Jost',sans-serif",fontWeight:300,overflow:"hidden",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"32px 24px"}}>
        ...
        <div style={{position:"absolute",inset:0,backgroundImage:`radial-gradient(circle at 20% 80%,${TEAL}08 0%,transparent 50%),radial-gradient(circle at 80% 20%,${TEAL}08 0%,transparent 50%)`}}/>
        {/* Декор волны сверху */}
        <div style={{position:"absolute",top:0,left:0,right:0,height:60,overflow:"hidden",opacity:0.3}}>
          <svg viewBox="0 0 480 60" style={{width:"100%",height:60}} preserveAspectRatio="none">
            <path d="M0,30 Q60,10 120,30 Q180,50 240,30 Q300,10 360,30 Q420,50 480,30 L480,0 L0,0 Z" fill={TEAL} opacity="0.3"/>
            <path d="M0,40 Q60,22 120,40 Q180,58 240,40 Q300,22 360,40 Q420,58 480,40 L480,0 L0,0 Z" fill={TEAL} opacity="0.15"/>
          </svg>
        </div>
        {/* Декор волны снизу */}
        <div style={{position:"absolute",bottom:0,left:0,right:0,height:60,overflow:"hidden",opacity:0.3}}>
          <svg viewBox="0 0 480 60" style={{width:"100%",height:60}} preserveAspectRatio="none">
            <path d="M0,30 Q60,10 120,30 Q180,50 240,30 Q300,10 360,30 Q420,50 480,30 L480,60 L0,60 Z" fill={TEAL} opacity="0.3"/>
          </svg>
        </div>
        ...
        <div style={{position:"relative",zIndex:1,width:"100%",maxWidth:360,display:"flex",flexDirection:"column",gap:8,opacity:langAnim?0:1,transition:"opacity 0.4s"}}>
          {LANGS.map(([code,flag,sub],i)=>(
            <button key={code} onClick={()=>chooseLang(code)} style={{width:"100%",padding:"13px 20px",background:WHITE,border:`1px solid ${BORDER}`,cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",gap:14,animation:`fadeInUp 0.5s ease ${i*0.07}s both`,boxShadow:`0 1px 8px ${BORDER}`}}>
  ...
  // ── CARRITO ──
  if(showCarrito){
    if(showEncuesta) return(<div style={{background:CREAM,minHeight:"100vh",width:"100%",overflowX:"hidden"}}><Encuesta lang={lang} onSubmit={()=>{setShowEncuesta(false);nuevosPedido();}} onSkip={()=>{setShowEncuesta(false);nuevosPedido();}}/></div>);
    return(
      <div style={{background:CREAM,minHeight:"100vh",width:"100%",fontFamily:"'Jost',sans-serif",fontWeight:300,color:NAVY,display:"flex",flexDirection:"column",overflowX:"hidden"}}>
        <style>{FONTS}</style>
                ...
                {carrito.map((item,idx)=>(
                  <div key={idx} style={{display:"flex",alignItems:"center",gap:12,padding:"14px 0",borderBottom:`1px solid ${BORDER}`}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:8}}>
                      ...
                      <span style={{fontSize:13,fontWeight:400,color:NAVY,minWidth:16,textAlign:"center"}}>{item.cantidad}</span>
  ...
  return(
    <div style={{background:CREAM,fontFamily:"'Jost',sans-serif",fontWeight:300,color:NAVY,minHeight:"100vh",maxWidth:480,margin:"0 auto",overflowX:"hidden",width:"100%"}}>
      ...
      {/* NAV */}
      <nav style={{position:"sticky",top:0,zIndex:50,background:"rgba(247,244,238,0.97)",backdropFilter:"blur(12px)",borderBottom:`1px solid ${BORDER}`,display:"flex",overflowX:"auto",scrollbarWidth:"none" as const,padding:"0 4px"}}>
      ...
      <div style={{paddingBottom:100}}>
            ...
            <div key={cat} style={{opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(12px)",transition:`all 0.5s ease ${gi*0.08}s`}}>
              ...
              <div style={{padding:"0 20px"}}>
                {(catItems as any[]).map((item,idx)=>{
                  ...
                  return(
                    <div key={idx} style={{display:"flex",alignItems:"baseline",gap:8,padding:"13px 0",borderBottom:`1px solid ${BORDER}`}}>
                      <div style={{flex:1,minWidth:0}}>
        ...
        <footer onClick={handleFooterTap} style={{margin:"28px 20px 0",paddingTop:24,borderTop:`1px solid ${BORDER}`,textAlign:"center",cursor:"default"}}>
          ...
          <div style={{margin:"0 auto",width:"100%",maxWidth:280}}>
            <svg viewBox="0 0 280 16" style={{width:"100%"}}>
              <path d="M0,8 Q35,1 70,8 Q105,15 140,8 Q175,1 210,8 Q245,15 280,8" fill="none" stroke={TEAL} strokeWidth="1" opacity="0.3"/>
            </svg>
          </div>
